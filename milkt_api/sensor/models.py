...
class User(models.Model):
  ...
  delete_time = models.DateTimeField(default=datetime.now(), blank=True)
...
class Sensor_Data(models.Model):
  ...
  rcv_time = models.DateTimeField(default=datetime.now(), blank=True)
  is_deleted = models.BooleanField(default=FALSE)
  create_time = models.DateTimeField(default=datetime.now(), blank=True)
  update_time = models.DateTimeField(default=datetime.now(), blank=True)
  delete_time = models.DateTimeField(default=datetime.now(), blank=True)
...
class Log(models.Model):
  ...
  sensor_uid = models.IntegerField
  sensor_date_id = models.ForeignKey(Sensor_Data, on_delete=models.DO_NOTHING)
